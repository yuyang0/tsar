...
struct stats_nginx_live {
    unsigned long long online;      /* 0 total online count */
...
static struct mod_info nginx_info[] = {
    ...
    {"uspeed", SUMMARY_BIT, MERGE_NULL,  STATS_NULL},  /*4 */
    {"downfl", SUMMARY_BIT, MERGE_NULL,  STATS_NULL},  /*5*/
    {"dspeed", SUMMARY_BIT, MERGE_NULL,  STATS_NULL},  /*6*/
    {"fmtime", SUMMARY_BIT, MERGE_NULL,  STATS_NULL},  /*7*/
    {"fmdata", HIDE_BIT   , MERGE_NULL,  STATS_NULL},  /*8*/
    {"dropfr", SUMMARY_BIT, MERGE_NULL,  STATS_NULL}   /*9*/
};
    ...
    U_64 pre_array[], U_64 cur_array[], int inter)
{
    ...
    if (cur_array[4] >= pre_array[4]) {
        st_array[4] = (cur_array[4] - pre_array[4]) * 1.0 / inter;
    }
